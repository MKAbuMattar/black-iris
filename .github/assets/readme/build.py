...
LANGS = {
    "en": dict(
        ...
        promise1="One skill, eleven disciplines for a coding agent.",
        promise2="Answer first. Exact numbers. Warnings kept. Done means checked.",
        promise3="", rtl=False,
        table="ROUTING TABLE", table_sub="say it, get the mode",
        desc="One Claude Code skill with eleven disciplines for a coding agent. The routing table of modes is shown beside the name.",
    ...
    "es": dict(
        ...
        promise1="Una habilidad, once disciplinas para un agente de programacion.",
        ...
        desc="Una habilidad de Claude Code con once disciplinas para un agente de programacion. La tabla de modos aparece junto al nombre.",
    ...
    "ar": dict(
        ...
        promise1="مهارة واحدة، إحدى عشرة قاعدة عمل لوكيل البرمجة.",
        promise2="الجواب أولاً. أرقام دقيقة. التحذيرات باقية. المنجَز هو المُتحقَّق منه.",
        promise3="", rtl=True,
        table="جدول الأنماط", table_sub="قلها، يعمل النمط",
        desc="مهارة واحدة لـ Claude Code بإحدى عشرة قاعدة عمل لوكيل البرمجة. جدول الأنماط بجانب الاسم.",
